...
```http
GET /api/xxe/objects/OBJECT_B HTTP/1.1
...
```http
PATCH /api/xxe/objects/OBJECT_B HTTP/1.1
Host: api.example.test
Authorization: Bearer <USER_A_TOKEN>
Content-Type: application/json
...
[Previous: OS Command Injection](command-injection.md) · [Back to README](../README.md) · [Next: Server-Side Request Forgery](ssrf.md)
