...
```http
GET /api/cors/objects/OBJECT_B HTTP/1.1
...
```http
PATCH /api/cors/objects/OBJECT_B HTTP/1.1
Host: api.example.test
Authorization: Bearer <USER_A_TOKEN>
Content-Type: application/json
...
[Previous: Content Security Policy](csp.md) · [Back to README](../README.md) · [Next: WebSocket Security](websocket-security.md)
