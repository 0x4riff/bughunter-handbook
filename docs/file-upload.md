...
```http
GET /api/file-upload/objects/OBJECT_B HTTP/1.1
...
```http
PATCH /api/file-upload/objects/OBJECT_B HTTP/1.1
Host: api.example.test
Authorization: Bearer <USER_A_TOKEN>
Content-Type: application/json
...
[Previous: WebSocket Security](websocket-security.md) · [Back to README](../README.md) · [Next: Path Traversal & File Inclusion](path-traversal-file-inclusion.md)
