...
```http
GET /api/csp/objects/OBJECT_B HTTP/1.1
...
```http
PATCH /api/csp/objects/OBJECT_B HTTP/1.1
Host: api.example.test
Authorization: Bearer <USER_A_TOKEN>
Content-Type: application/json
...
[Previous: Cross-Site Scripting](xss.md) · [Back to README](../README.md) · [Next: Cross-Origin Resource Sharing](cors.md)
