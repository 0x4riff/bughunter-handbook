...
```http
GET /api/path-traversal-file-inclusion/objects/OBJECT_B HTTP/1.1
...
```http
PATCH /api/path-traversal-file-inclusion/objects/OBJECT_B HTTP/1.1
Host: api.example.test
Authorization: Bearer <USER_A_TOKEN>
Content-Type: application/json
...
[Previous: File Upload Security](file-upload.md) · [Back to README](../README.md) · [Next: SQL Injection](sql-injection.md)
