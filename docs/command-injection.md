...
```http
GET /api/command-injection/objects/OBJECT_B HTTP/1.1
...
```http
PATCH /api/command-injection/objects/OBJECT_B HTTP/1.1
Host: api.example.test
Authorization: Bearer <USER_A_TOKEN>
Content-Type: application/json
...
[Previous: SQL Injection](sql-injection.md) · [Back to README](../README.md) · [Next: XML External Entity Injection](xxe.md)
