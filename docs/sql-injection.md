...
```http
GET /api/sql-injection/objects/OBJECT_B HTTP/1.1
...
```http
PATCH /api/sql-injection/objects/OBJECT_B HTTP/1.1
Host: api.example.test
Authorization: Bearer <USER_A_TOKEN>
Content-Type: application/json
...
[Previous: Path Traversal & File Inclusion](path-traversal-file-inclusion.md) · [Back to README](../README.md) · [Next: OS Command Injection](command-injection.md)
